...
["name"] = "이름",
["right thigh"] = "오른쪽 허벅지",
["ping pong loop"] = "핑퐁루프(Ping Pong Loop)",
["min"] = "최소",
["left forearm"] = "왼쪽 팔",
["light"] = "빛",
...
["wear on server"] = "착용 ",
["clear"] = "지우기",
["convert active pac2 outfit pac2"] = "pac2파일 변환",
["draw distance"] = "pac3 활성화 거리",
["wear parts"] = "이파트를 착용",
["clear parts"] = "이파트를 초기화",
["toggle focus"] = "토글 포커스(toggle focus)",
["language"] = "언어 설정",
["help"] = "도움말",
["draw order"] = "렌더 순서",
["root owner"] = "루트 오너",
...
["axis"] = "축",
["additive"] = "첨가",
["input divider"] = "인풋 디바이더(input divider)",
...
["ground"] = "땅바닥",
["reset on hide"] = "숨김 리셋",
["constrain pitch"] = "Pitch값 제한",
["constrain yaw"] = "Yaw값 제한",
["constrain roll"] = "Roll값 제한",
...
["max speed"] = "한도 속도",
["max angular"] = "한도 각",
["max speed damp"] = "최대 속도제동값",
["max angular damp"] = "최대 각도제동값",
["damp factor"] = "습기 양",
...
["is crouching"] = "앉기",
["speed"] = "속도",
["is flashlight on"] = "손전등을 사용중일때",
["is in noclip"] = "노클립중일때",
["is on ground"] = "지상에있을때",
["owner armor"] = "사용자의 아머량",
["is client"] = "오직 클라이언트만",
["equal"] = "같을때",
["not equal"] = "같지 않을때",
["above"] = "초과일때",
...
["show only with active weapon"] = "착용중인 무기표시의 유무",
["hide weapon"] = "무기 숨기기",
["show weapon"] = "무기 보이기",
["view"] = "보기",
["options"] = "옵션",
...
["show deprecated features"] = "자세한 옵션들 표기",
["rendering"] = "렌더링",
